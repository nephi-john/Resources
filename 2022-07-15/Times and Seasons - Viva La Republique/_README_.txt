...
12 "months" each have 30 days.  A "week" is a decan with two pentads (M-F) for the two genders (M/F). [Non-binaries at any point in time can choose to be assigned either M or F.  {e.g., a holiday for "females" that a non-binary wants to go, chooses "F" ... doesn't want to go, chooses "M"} ... androgyny as both has more options]  The first "week" is the mother/father, the second "week" is the daughter/son, the third "week" is the al-mother/al-father (grandparents*). [Maybe order should be al-mother/al-father, mother/father, daughter/son ... cascading DESC ... Yeshua would then be the father with a father (al-father) and children (daughters and sons)] [Hiercharcy dictates that an al-mother/al-father at any time can choose to be a less classification ... as can mother/father ... downward options {e.g., a holiday for "daughters" that a al-mother wants to go, chooses "daughter" ... doesn't want to go, chooses "not daughter"} ... a caste system based on honoring ab-at-em ... 
...
** TIME will be anchored to a fixed point (either the center of Khufer/Giza pyramid or the center of the oval at Serpent Mound, Ohio).  All timezones will anchor to this fixed point and will be based on LONGITUDE w/o any weird exceptions.  Each timezone will be a function of "10 degrees" (10 steps of Isaiah) ... 36 divisions of time to equate to the 36 hours in the day ... Hours will be based on the notion that they are equal at the EQUINOX (12/12 becomes 18/18).  Latitude, Longitude should be able to ascertain the time at any point on earth using the 36-hour model.  As epoch's, hours can be halfed (1/2, 1/4, 1/8, 1/16, ...) but there are seasons of hours in the day divided int groups of 3 groups of 6 hours {or 6 groups of 3 hours, but not 9/2 or 2/9} (sunrise, morning, mid-morning), (early noon, noon, late noon), (afternoon, late afternoon, sunset) {night also has 3 groups of 6 hour watches ... anchor to ISLAM traditions regarding various forms of pre sunrise and post-sunset (nautical vs astronical) (twilight vs dusk) ... with 360 degrees in a circle and 36 hours in a day, each on EQUINOX would be exactly 10 degrees, but would varying throught the year on the edge conditions ... night divisions do not have to be EQUAL as daytime hours are ... just needs to be 18) This time measure is about day-time not fixed seconds. At equinox 36 new hours = 24 old hours or 40 real-time minutes ... speeding up time)  That is, in winter in Alaska there may be 18 day hours each with 0 fixed seconds.  What time is it BECOMES a function of SOLAR NOON where you live (half of sunrise/sunset where these times account for refraction and obstructions like mountains) ... that is, VISIBLE LIGHT ... sunrise (first light) to sunset (last light, even though sun has already set, refraction).  WINTER months have shorter hours, SUMMER months have longer hours... This time can be measured on a SUNDIAL (Asherah May Pole) and can be linked to modern "water clocks" such as crystals and atomic clocks. [A day schedule becomes a problem, maybe we should keep things that generic:  I will get to work "one hour" after sunrise {which changes every day} ... I will be there "half past noon" {half hour past solar noon}] ... Time is a function of Latitude and Longitude and Solar Date ... 
